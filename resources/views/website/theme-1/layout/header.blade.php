                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu"><span class="dropdown-menu-title-only">User
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="page-user-login-cover.html">Login - Side Cover</a>
                                            </li>
                                            ...
                                            <li><a href="page-user-register-classic.html">Register -
                                                    Classic</a></li>
                                            <li><a href="page-user-password-recovery.html">Recovery
                                                    Password</a></li>
                                        </ul>
                                    </li>
