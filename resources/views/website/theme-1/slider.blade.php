           ...
           <div id="rev_slider_24_1" class="rev_slider fullscreenbanner tiny_bullet_slider" style="display:none;"
               ...
               <ul>
                   ...
                   <li data-index="rs-67" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                       ...
                       data-thumb="{{ asset('theme-1/plugins/slider-revolution/assets/images/woman2-100x50.jpg') }}"
                       data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                       data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
                       data-param9="" data-param10="" data-description=""
                       data-slicey_shadow="0px 0px 0px 0px transparent">
                       <!-- MAIN IMAGE -->
                       <img src="{{ asset('img/3.jpeg') }}" alt="" data-bgposition="center center"
                       ...
                       <div class="tp-caption   tp-resizeme" id="slide-67-layer-2"
                           ...
                           Bienvenido al mundo <br> de la aviación. </div>
                       <!-- LAYER NR. 16 -->
                       <div class="tp-caption   tp-resizeme" id="slide-67-layer-3"
                           ...
                           ¡Despega tu pasión en los cielos colombianos! </div>
                       <!-- LAYER NR. 17 -->
                       {{-- <a class="tp-caption rev-btn  tp-resizeme"
                           ...
                           style="z-index: 21; min-width: 250px; max-width: 250px; white-space: nowrap; font-size: 18px; line-height: 60px; font-weight: 700; color: rgba(255,255,255,1); letter-spacing: px;font-family:Rubik;background-color:rgb(87,202,133);border-color:rgba(0,0,0,1);border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">GET
                           STARTED </a> --}}
                   </li>
                   <!-- SLIDE  -->
                   <li data-index="rs-66" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                       data-hideslideonmobile="off" data-easein="default" data-easeout="default"
                       data-masterspeed="600" data-thumb="plugins/slider-revolution/assets/images/deskbg-100x50.jpg"
                       data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                       data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
                       data-param9="" data-param10="" data-description=""
                       data-slicey_shadow="0px 0px 0px 0px transparent">
                       <!-- MAIN IMAGE -->
                       <img src="{{ asset('img/4.jpeg') }}" alt="" data-bgposition="center center"
                       ...
                       <div class="tp-caption   tp-resizeme" id="slide-66-layer-3"
                           ...
                           data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                           style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; letter-spacing: 0px;font-family:Rubik;">
                           Discover our 90+ Template Library and range of free Add-Ons. </div>
                       <!-- LAYER NR. 34 -->
                       <a class="tp-caption rev-btn  tp-resizeme"
                           href="https://revolution.themepunch.com/direct-customer-benefits/" target="_blank"
                           ...
                           data-paddingright="[50,50,50,50]" data-paddingbottom="[0,0,0,0]"
                           data-paddingleft="[50,50,50,50]"
                           style="z-index: 21; min-width: 250px; max-width: 250px; white-space: nowrap; font-size: 18px; line-height: 60px; font-weight: 700; color: rgba(255,255,255,1); letter-spacing: px;font-family:Rubik;background-color:rgb(87,202,133);border-color:rgba(0,0,0,1);border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">DIVE
                           RIGHT IN </a>
                   </li>
                   <!-- SLIDE  -->
                   <li data-index="rs-68" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                       ...
                       data-thumb="{{ asset('theme-1/plugins/slider-revolution/assets/images/reachout_bg-100x50.jpg') }}"
                       data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                       data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
                       data-param9="" data-param10="" data-description=""
                       data-slicey_shadow="0px 0px 0px 0px transparent">
                       <!-- MAIN IMAGE -->
                       <img src="{{ asset('img/medellin.jpeg') }}" alt="" data-bgposition="center center"
                           data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut"
                           data-scalestart="100" data-scaleend="150" data-rotatestart="0" data-rotateend="0"
                           data-blurstart="20" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0"
                           class="rev-slidebg" data-no-retina>
                       ...
                       <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme"
                           ...
                           data-hoffset="['-522','492','-151','262']" data-y="['middle','middle','middle','middle']"
                       ...
                       <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme"
                           ...
                           data-hoffset="['-37','73','-76','-100']" data-y="['middle','middle','middle','middle']"
                       ...
                       <div class="tp-caption   tp-resizeme" id="slide-68-layer-2"
                           ...
                           style="z-index: 19; white-space: nowrap; font-size: 90px; line-height: 90px; font-weight: 500; color: #ffffff; letter-spacing: -5px;font-family:Rubik;">
                           Experience the<br /> Revolution </div>
                       <!-- LAYER NR. 50 -->
                       <div class="tp-caption   tp-resizeme" id="slide-68-layer-3"
                           ...
                           data-paddingleft="[0,0,0,0]"
                           style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; letter-spacing: 0px;font-family:Rubik;">
                           Cutting edge features, tons of examples, regular security checks. </div>
                       <!-- LAYER NR. 51 -->
                       <a class="tp-caption rev-btn  tp-resizeme"
                           ...
                           target="_blank" id="slide-68-layer-7" data-x="['center','center','center','center']"
                           data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']"
                           data-voffset="['200','200','160','120']" data-width="250" data-height="none"
                           ...
                           data-paddingright="[50,50,50,50]" data-paddingbottom="[0,0,0,0]"
                           data-paddingleft="[50,50,50,50]"
                           style="z-index: 21; min-width: 250px; max-width: 250px; white-space: nowrap; font-size: 18px; line-height: 60px; font-weight: 700; color: rgba(255,255,255,1); letter-spacing: px;font-family:Rubik;background-color:rgb(87,202,133);border-color:rgba(0,0,0,1);border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">BUY
                           RVSLDR NOW </a>
                   </li>
               </ul>
   ...
   <!-- end: Revolution Slider-->
   @push('scripts')
       <link href="https://fonts.googleapis.com/css?family=Rubik:500%2C400%2C700" rel="stylesheet"
       ...
       <link rel="stylesheet" type="text/css"
           href="{{ asset('theme-1/plugins/slider-revolution/css/settings.css') }}">
       <style type="text/css">
       ...
       <!-- REVOLUTION JS FILES -->
       <script type="text/javascript" src="{{ asset('theme-1/plugins/slider-revolution/js/jquery.themepunch.tools.min.js') }}">
       </script>
