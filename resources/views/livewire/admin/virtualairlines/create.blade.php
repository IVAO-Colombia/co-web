    ...
    <x-jet-modal wire:model='modal' id="slider">
        <form>
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div class="mb-4">
                    <span
                        class="block text-gray-700 text-sm font-bold mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">SHOW
                        IN WEB:</span>
                    <label for="show_in_web" class="inline-flex relative items-center cursor-pointer">
                        <input type="checkbox" id="show_in_web" class="sr-only peer" wire:model.defer="show_in_web">
                        <div
