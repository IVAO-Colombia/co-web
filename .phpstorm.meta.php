...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/santiago/Repos/co-web/public/storage' => 'string',
            ...
            'services.ivao.client_id' => 'string',
            'services.ivao.client_secret' => 'string',
            'services.ivao.redirect' => 'string',
            'services.ivao.api_key' => 'string',
            'services.ivao.api_url' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/santiago/Repos/co-web/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'services.slack.notifications.channel','services.ivao.client_id','services.ivao.client_secret','services.ivao.redirect','services.ivao.api_key',
'services.ivao.api_url','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'permission.cache.store','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver','structure-discoverer.cache.store',
...
'boost.browser-logs','home','auth.redirect','auth.callback',
'auth.logout','dashboard','ivao.airports.atc-positions','profile.edit',
'appearance.edit','events.index','events.create','events.store','events.show',
'events.edit','events.update','events.destroy','storage.local','storage.local.upload',);
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','VITE_SSR_ENABLED','IVAO_CLIENT_ID','IVAO_CLIENT_SECRET',
'IVAO_REDIRECT_URI','IVAO_API_KEY','IVAO_API_URL',);
